...
.. note::
   ...
   See `CONTRIBUTING.md <https://github.com/canonical/osquery-operator/blob/main/CONTRIBUTING.md>`_
   for information on contributing to the source code. 

Our documentation is hosted on `Read the Docs <https://osquery.readthedocs.io/en/latest/>`_ to enable collaboration.
...
`source code on GitHub <https://github.com/canonical/osquery-operator>`_.
You may open a pull request with your documentation changes, or you can
`file a bug <https://github.com/canonical/osquery-operator/issues>`_ to provide constructive feedback or suggestions.
