...
// The value must not include 'https://' and must not end with a trailing '/'.
const rtd_address = 'canonical-osquery-operator.readthedocs-hosted.com';
const new_address = 'canonical.com/juju/docs/osquery-charm';
